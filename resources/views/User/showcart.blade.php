    ...
    <!-- Page Content -->
     ...
     <div style="padding: 100px;" align="center">
        <form action="{{ url('order') }}" method="POST">
            @csrf
        <table>
            <tr style="background-color: rgba(255, 17, 0, 0.72);">
            ...
            <tr style="background-color: black;">
                ...
                <td style="padding: 10px;  font-size:20px; color:white;"><a class="btn btn-danger" href="{{ url('delete',$carts->id) }}">Delete</a></td>
            </tr>
            @endforeach
        </table>
